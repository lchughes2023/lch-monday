...
const ACHIEVEMENTS = [
  {
    ...
    emoji: '🎯',
    name: 'First Step',
    desc: 'Get your first answer correct',
  },
  {
    id: 'first-log',
    emoji: '✏️',
    name: 'Thought Logged',
    desc: 'Add your first idea to the journal',
  },
  {
    id: 'route-finder',
    emoji: '🗺',
    name: 'Route Finder',
    desc: 'Get 5 correct answers total',
  },
  {
    id: 'streak-hunter',
    emoji: '🔥',
  ...
  },
  {
    ...
    emoji: '📓',
    name: 'Journal Keeper',
    desc: 'Log 10 ideas to the journal',
  },
  {
    id: 'palace-scholar',
    emoji: '🎓',
  ...
  },
  {
    ...
    emoji: '🏆',
    name: 'Perfect Round',
    desc: 'Complete a Route-It round with 100% accuracy',
  },
]
...
export default function ProgressPanel({ progress, setProgress }) {
  ...
  function handleReset() {
    setProgress(INITIAL)
    localStorage.removeItem('memoryPalaceProgress')
  ...
  return (
    <div className="progress-panel">
      ...
      <div className="stats-grid">
        ...
        <div className="stat-card">
          <div className="stat-value">{progress.bestStreak ?? progress.streak}</div>
          <div className="stat-label">Best Streak</div>
        </div>
        <div className="stat-card">
          <div className="stat-value">{(progress.journalEntries || []).length}</div>
